...
- A `Request Leave` button must open a modal form with:
  - leave type
  - start date
  - end date
  - optional reason
- Show a table of past requests with:
  - type
  - start date
  - end date
  - requested days
...
- A table of all non-admin employees with columns:
  - name
  - email
  - department
  - role
...
- Number inputs for:
  - annual leave limit, default `20`
  - sick leave limit, default `10`
  - casual leave limit, default `5`
